...
export function MarketRow({ market }: { market: Market }) {
  ...
  return <Link href={`/assets/${encodeURIComponent(market.symbol)}`} className="panel panel-hover grid grid-cols-[1.2fr_.8fr_110px_100px] items-center gap-3 px-4 py-3 no-underline" data-testid={`row-market-${market.symbol}`}>
