...
import { ArrowDownRight, ArrowUpRight, BarChart3, CheckCircle2, CircleDot, Clock3, ExternalLink, Gauge, Info, LockKeyhole, Pause, Play, Plus, Radio, RefreshCw, ShieldAlert, SlidersHorizontal, Sparkles, Target, Timer, Wifi } from 'lucide-react';
...
export function AssetPage() {
  ...
  const analysisPanels = asset ? [{ label: t('asset.techBrain'), data: asset.technical, color: 'text-accent' }, { label: t('asset.fundBrain'), data: asset.fundamental, color: 'text-primary' }, { label: t('asset.riskBrain'), data: asset.risk, color: 'text-[hsl(209_78%_65%)]' }] : [];
