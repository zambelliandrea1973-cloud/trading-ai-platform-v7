...
import { ArrowDownRight, ArrowUpRight, CheckCircle2, CircleDot, Gauge, RefreshCw, ShieldCheck, Sparkles, Target, Wifi } from 'lucide-react';
  ...
  return <div className="content-wrap">
    ...
    <section className="mb-5 rounded-lg border border-border bg-card/55 p-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Badge tone="teal"><Sparkles size={11} /> AI attiva</Badge>
        </div>
    ...
    {buyDecision && <section className="mb-5 rounded-lg border border-primary/45 bg-primary/5 p-5">
      ...
      <div className="grid gap-3 sm:grid-cols-4">
        <div className="rounded-md bg-secondary/45 p-3"><p className="eyebrow">Stato AI</p><p className="mono mt-1 text-sm text-accent">AI attiva</p></div>
    ...
    <Notice tone="teal"><span><strong>Ambiente simulato.</strong> La dashboard V7.1 non abilita esecuzione live e mantiene protetta la logica interna dell'AI.</span></Notice>
  </div>;
}
